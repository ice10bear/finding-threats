...
#### 3. Просмотр общуей структуры данных с помощью функции glimpse()
...
В результате успешного выполнения задания произошло значительное совершенствование компетенций в области языка программирования R, особенно в контексте обработки данных. Приобретенные навыки включают в себя более глубокое понимание методов и инструментов для эффективной обработки данных с использованием R, что способствует повышению эффективности и качества аналитических работ.

## Вывод

В процессе выполнения задачи были проанализированы структура журнала системы Windows Active Directory и освоены дополнительные техники обработки данных с применением основных инструментов экосистемы tidyverse в языке программирования R. Эти новые навыки и знания предоставляют более широкий набор инструментов для эффективной работы с данными и улучшают общую квалификацию в области аналитики и обработки информации.